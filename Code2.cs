...
class Program
{
    ...
    {
        CheckingAccount checking = new CheckingAccount("CHK12345", 1263, "Александр Иванов", 5000);
        SavingsAccount savings = new SavingsAccount("SAV67890", 4267, "Михаил Петрович", 10);
